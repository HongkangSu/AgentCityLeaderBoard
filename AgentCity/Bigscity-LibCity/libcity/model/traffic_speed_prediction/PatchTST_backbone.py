# PatchTST Backbone for LibCity
# Adapted from: https://github.com/yuqinie98/PatchTST/blob/main/PatchTST_supervised/layers/PatchTST_backbone.py
...
from libcity.model.traffic_speed_prediction.PatchTST_layers import (
    Transpose, get_activation_fn, positional_encoding
)
from libcity.model.traffic_speed_prediction.RevIN import RevIN
...
class _MultiheadAttention(nn.Module):
    ...
    def forward(self, Q: Tensor, K: Optional[Tensor] = None, V: Optional[Tensor] = None,
        ...
        k_s = self.W_K(K).view(bs, -1, self.n_heads, self.d_k).permute(0, 2, 3,
                                                                       1)  # k_s: [bs x n_heads x d_k x q_len]
...
class _ScaledDotProductAttention(nn.Module):
    ...
    (Realformer: Transformer likes residual attention by He et al, 2020) and locality self attention
    (Vision Transformer for Small-Size Datasets by Lee et al, 2021)"""
