"""
START Abstract Executor
Migrated from: /repos/START/libcity/executor/abstract_executor.py

This is an enhanced AbstractExecutor that provides full implementation for:
- Optimizer and learning rate scheduler building
- Model saving/loading with epoch tracking
- TensorBoard logging support
- Graph feature handling

This executor is the base class for START model executors and differs from
LibCity's original minimal AbstractExecutor.
"""
...
class STARTAbstractExecutor(object):
    """
    Enhanced Abstract Executor for START model.

    This provides a fully implemented base executor with:
    - Optimizer building (Adam, AdamW, SGD, etc.)
    - LR scheduler support (including custom CosineLRScheduler)
    - Model checkpoint saving/loading
    - TensorBoard logging
    - Graph feature handling for trajectory models
    """
    ...
    def _build_optimizer(self):
        """
        Build optimizer based on config parameter 'learner'
        """
    ...
    def _build_lr_scheduler(self):
        """
        Build learning rate scheduler based on config parameter 'lr_scheduler'
        """
        if self.lr_decay:
    ...
    def _train_epoch(self, train_dataloader, epoch_idx):
        raise NotImplementedError("Executor _train_epoch not implemented")

    def _valid_epoch(self, eval_dataloader, epoch_idx, mode='Eval'):
        raise NotImplementedError("Executor _valid_epoch not implemented")

    def _draw_png(self, data):
        raise NotImplementedError("Executor _draw_png not implemented")
